...
st.markdown("<h1 style='text-align: center; color: cyan;'>RWE : CEOs Panel Linkedin Post </h1>", unsafe_allow_html=True)


filter_day, filter_Interactions, filter_date = display_filters()

dataframe_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/QvgeSx1xWZTeLGOmoB1h7Q/rwe_ceos.csv'
