...
st.markdown("<h1 style='text-align: center; color: cyan;'>RWE Konzern Accounts </h1>", unsafe_allow_html=True)


filter_day, filter_Interactions, filter_date = display_filters()

dataframe_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/hhs4hjyjJ5NrniextWy9kA/rwe_konzern.csv'
