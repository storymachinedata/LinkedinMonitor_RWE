...
st.markdown("<h1 style='text-align: center; color: green;'>RWE: Energiewirtschaft CEOs Posts</h1>", unsafe_allow_html=True)

filter_day, filter_Interactions, filter_date = display_filters()

dataframe_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/gZvzIVB62vUIB3Z5zxWhKQ/rwe_energiewirtschaft.csv'
