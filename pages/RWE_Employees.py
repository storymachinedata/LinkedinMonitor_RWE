...
st.markdown("<h1 style='text-align: center; color: cyan;'>RWE Employees Linkedin posts </h1>", unsafe_allow_html=True)


filter_day, filter_Interactions, filter_date = display_filters()

dataframe_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/pUXniMropSRLYkq5Pbw2vQ/RWE_employees.csv'
