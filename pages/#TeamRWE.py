...
st.markdown("<h1 style='text-align: center; color: green;'>RWE: #TEAMRWE Monitor</h1>", unsafe_allow_html=True)

filter_day, filter_Interactions, filter_date = display_filters()

dataframe_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/hIMTABCvWJ9KLONx3MeTpQ/teamrwe_keyword_search.csv'
